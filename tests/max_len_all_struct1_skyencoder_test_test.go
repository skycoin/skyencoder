...
func testSkyencoderMaxLenAllStruct1(t *testing.T, obj *MaxLenAllStruct1) {
	...
	err = DecodeMaxLenAllStruct1(data2, &obj3)
	if err != nil {
...
func decodeMaxLenAllStruct1ExpectError(t *testing.T, buf []byte, expectedErr error) {
	var obj MaxLenAllStruct1
	err := DecodeMaxLenAllStruct1(buf, &obj)
...
func testSkyencoderMaxLenAllStruct1DecodeErrors(t *testing.T, k int, obj *MaxLenAllStruct1) {
	...
	t.Run(fmt.Sprintf("%d remaining bytes", k), func(t *testing.T) {
		decodeMaxLenAllStruct1ExpectError(t, buf[:], encoder.ErrRemainingBytes)
	})
}
...
func TestSkyencoderMaxLenAllStruct1DecodeErrors(t *testing.T) {
	...
	for i := 0; i < n; i++ {
		...
		testSkyencoderMaxLenAllStruct1DecodeErrors(t, i, emptyObj)
		testSkyencoderMaxLenAllStruct1DecodeErrors(t, i, fullObj)
	}
}
